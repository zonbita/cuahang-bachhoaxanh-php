...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
   $data=
    ...
    // if(postInput('sale')=='')
    // {
    //     $error['sale']="Bạn phải nhập giảm giá";
    // }
    if(postInput('number')=='')
    {
...
<form class="form-horizontal" role="form" action="" method="POST" enctype="multipart/form-data">
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <select class="form-control" name="category_id">
                <option value="">Mời chọn danh mục tương ứng</option>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" id="inputnumber" placeholder="" name="number"
